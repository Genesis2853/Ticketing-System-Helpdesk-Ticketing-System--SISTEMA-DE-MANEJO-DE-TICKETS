...
const RepServT = ({ user }) => {
    ...
    console.log("Usuario recibido en reporteserv:", user);
    ...
    useEffect(() => {
        ...
        const fetchReportesSolicitud = async () => {
            ...
            try {
                const response = await fetch(`${process.env.REACT_APP_API_URL_ESTADO}/api/soliComplTec`, { 
                    signal, 
                    headers: {
    ...
    useEffect(() => {
        ...
        const fetchReporteSoliNoRealizado = async () => {
            ...
            try {
                const response = await fetch(`${process.env.REACT_APP_API_URL_ESTADO}/api/soliNoReTec`, { 
                    signal,
                    headers: {
                        'Authorization': `Bearer ${token}`, 
                    }, 
        ...
        <main className="main-Tec">
            <div className="estado-reporteSolicitudTec-container">
                <div className='div-contenedor-tituloybuscar'>
                    <h2 className="titulo-reportes">Reportes de Servicio</h2>
                    <input
                        type="text"
                        placeholder="Buscar..."
                        value={searchTerm}
                            ...
                            {filteredCompletadas.map(solicitud => (
                             ...
                             >
                                 <div className="card-content">
                                     <h3>Código: {solicitud.codigo_ticket}</h3>
