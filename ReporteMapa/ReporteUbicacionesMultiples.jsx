...
const ReporteUbicacionesMultiples = ({ ubicaciones = [], obtenerNombreTecnico }) => {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerContainer} fixed>
          ...
          <View style={styles.headerCenter}>
            <Text style={styles.headerText}>Reporte de Ubicaciones Filtradas</Text>
          </View>
          ...
          <View style={styles.table}>
            ...
            {ubicaciones.map((u, idx) => (
              <View
                ...
                wrap={false}
              >
                <Text style={styles.cell}>{obtenerNombreTecnico(u.codigo_trabajador) || 'N/D'}</Text>
...
export default ReporteUbicacionesMultiples;
